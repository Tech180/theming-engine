...
export default {
  color: {
    ...
    paper: {
      primary:              { $value: '#4a5568', $type: 'color', $description: 'Graphite ink primary' },
      primaryHover:         { $value: '#2d3748', $type: 'color' },
      bgLight:              { $value: '#f5f0e6', $type: 'color' },
      surfaceLight:         { $value: '#faf8f3', $type: 'color' },
      surfaceHoverLight:    { $value: '#ede8dc', $type: 'color' },
      borderLight:          { $value: '#d4cfc4', $type: 'color' },
      textLight:            { $value: '#2d3748', $type: 'color' },
      textMutedLight:       { $value: '#718096', $type: 'color' },
      bgDark:               { $value: '#1a1612', $type: 'color' },
      surfaceDark:          { $value: '#252019', $type: 'color' },
      surfaceHoverDark:     { $value: '#2f2820', $type: 'color' },
      borderDark:           { $value: '#4a4035', $type: 'color' },
      textDark:             { $value: '#f0ebe3', $type: 'color' },
      textMutedDark:        { $value: '#a89888', $type: 'color' },
    },

    paperMario: {
      marioRed:             { $value: '#E3001B', $type: 'color', $description: 'TTYD Mario red primary' },
      marioRedDark:         { $value: '#990012', $type: 'color' },
      luigiGreen:           { $value: '#00B140', $type: 'color' },
      luigiGreenDark:       { $value: '#00661A', $type: 'color' },
      toadBlue:             { $value: '#0066CC', $type: 'color' },
      toadBlueDark:         { $value: '#003366', $type: 'color' },
      starYellow:           { $value: '#FFCC00', $type: 'color' },
      paperWhite:           { $value: '#FFFFFF', $type: 'color' },
      paperWarm:            { $value: '#f4f0e6', $type: 'color' },
      textInk:              { $value: '#3a2e26', $type: 'color' },
      textInkMuted:         { $value: '#6b5344', $type: 'color' },
      dialogueBg:           { $value: 'rgba(15, 20, 35, 0.85)', $type: 'color' },
      stageBg:              { $value: '#08050c', $type: 'color' },
      bgLight:              { $value: '#87CEEB', $type: 'color' },
      surfaceLight:         { $value: '#FFFFFF', $type: 'color' },
      surfaceHoverLight:    { $value: '#f0f8ff', $type: 'color' },
      borderLight:          { $value: '#3a2e26', $type: 'color' },
      textLight:            { $value: '#3a2e26', $type: 'color' },
      textMutedLight:       { $value: '#6b5a4e', $type: 'color' },
      bgDark:               { $value: '#08050c', $type: 'color' },
      surfaceDark:          { $value: '#0f1423', $type: 'color' },
      surfaceHoverDark:     { $value: '#141c30', $type: 'color' },
      borderDark:           { $value: '#FFFFFF', $type: 'color' },
      textDark:             { $value: '#FFFFFF', $type: 'color' },
      textMutedDark:        { $value: 'rgba(255, 255, 255, 0.7)', $type: 'color' },
      /* Legacy aliases */
      primary:              { $value: '#E3001B', $type: 'color' },
      primaryHover:         { $value: '#990012', $type: 'color' },
      gold:                 { $value: '#FFCC00', $type: 'color' },
    },

    retro80s: {
      primary:              { $value: '#ff6ec7', $type: 'color', $description: 'Synthwave magenta primary' },
      primaryHover:         { $value: '#e055a8', $type: 'color' },
      bgLight:              { $value: '#fdf2f8', $type: 'color' },
      surfaceLight:         { $value: '#ffffff', $type: 'color' },
      surfaceHoverLight:    { $value: '#fce7f3', $type: 'color' },
      borderLight:          { $value: '#f9a8d4', $type: 'color' },
      textLight:            { $value: '#581c87', $type: 'color' },
      textMutedLight:       { $value: '#a855f7', $type: 'color' },
      cyan:                 { $value: '#00d4ff', $type: 'color' },
      orange:               { $value: '#ff9a00', $type: 'color' },
      bgDark:               { $value: '#1a0a2e', $type: 'color' },
      surfaceDark:          { $value: '#2d1b69', $type: 'color' },
      surfaceHoverDark:     { $value: '#3d2780', $type: 'color' },
      borderDark:           { $value: '#ff6ec7', $type: 'color' },
      textDark:             { $value: '#fce7f3', $type: 'color' },
      textMutedDark:        { $value: '#c084fc', $type: 'color' },
    },

    pixel: {
      primary:              { $value: '#e52521', $type: 'color', $description: 'NES cherry red primary' },
      primaryHover:         { $value: '#b91c1c', $type: 'color' },
      bgLight:              { $value: '#c0c0c0', $type: 'color' },
      surfaceLight:         { $value: '#fcfcfc', $type: 'color' },
      surfaceHoverLight:    { $value: '#e8e8e8', $type: 'color' },
      borderLight:          { $value: '#000000', $type: 'color' },
      textLight:            { $value: '#000000', $type: 'color' },
      textMutedLight:       { $value: '#404040', $type: 'color' },
      blue:                 { $value: '#209cee', $type: 'color' },
      yellow:               { $value: '#f7d308', $type: 'color' },
      bgDark:               { $value: '#1a1c2c', $type: 'color' },
      surfaceDark:          { $value: '#292b41', $type: 'color' },
      surfaceHoverDark:     { $value: '#3a3d5c', $type: 'color' },
      borderDark:           { $value: '#ffffff', $type: 'color' },
      textDark:             { $value: '#ffffff', $type: 'color' },
      textMutedDark:        { $value: '#a0a0a0', $type: 'color' },
    },

    matrix: {
      primary:              { $value: '#00ff41', $type: 'color', $description: 'Matrix terminal green primary' },
      primaryHover:         { $value: '#00cc33', $type: 'color' },
      bgLight:              { $value: '#e8f5e9', $type: 'color' },
      surfaceLight:         { $value: '#f1f8f2', $type: 'color' },
      surfaceHoverLight:    { $value: '#c8e6c9', $type: 'color' },
      borderLight:          { $value: '#81c784', $type: 'color' },
      textLight:            { $value: '#1b5e20', $type: 'color' },
      textMutedLight:       { $value: '#388e3c', $type: 'color' },
      bgDark:               { $value: '#0d0208', $type: 'color' },
      surfaceDark:          { $value: '#0a1f0a', $type: 'color' },
      surfaceHoverDark:     { $value: '#0f2f0f', $type: 'color' },
      borderDark:           { $value: '#003b00', $type: 'color' },
      textDark:             { $value: '#00ff41', $type: 'color' },
      textMutedDark:        { $value: '#00b030', $type: 'color' },
    },

    terminal: {
      primary:              { $value: '#ffb000', $type: 'color', $description: 'CRT amber primary' },
      primaryHover:         { $value: '#e69d00', $type: 'color' },
      bgLight:              { $value: '#f5f0e0', $type: 'color' },
      surfaceLight:         { $value: '#faf6eb', $type: 'color' },
      surfaceHoverLight:    { $value: '#ebe5d4', $type: 'color' },
      borderLight:          { $value: '#d4c4a0', $type: 'color' },
      textLight:            { $value: '#3d3000', $type: 'color' },
      textMutedLight:       { $value: '#8a7530', $type: 'color' },
      bgDark:               { $value: '#0a0a0a', $type: 'color' },
      surfaceDark:          { $value: '#141414', $type: 'color' },
      surfaceHoverDark:     { $value: '#1e1e1e', $type: 'color' },
      borderDark:           { $value: '#333333', $type: 'color' },
      textDark:             { $value: '#ffb000', $type: 'color' },
      textMutedDark:        { $value: '#997000', $type: 'color' },
    },

    vaporwave: {
      primary:              { $value: '#ff71ce', $type: 'color', $description: 'Vaporwave hot pink primary' },
      primaryHover:         { $value: '#e055a8', $type: 'color' },
      bgLight:              { $value: '#fdf4ff', $type: 'color' },
      surfaceLight:         { $value: '#ffffff', $type: 'color' },
      surfaceHoverLight:    { $value: '#fae8ff', $type: 'color' },
      borderLight:          { $value: '#e9d5ff', $type: 'color' },
      textLight:            { $value: '#581c87', $type: 'color' },
      textMutedLight:       { $value: '#a855f7', $type: 'color' },
      cyan:                 { $value: '#01cdfe', $type: 'color' },
      mint:                 { $value: '#05ffa1', $type: 'color' },
      bgDark:               { $value: '#1a0033', $type: 'color' },
      surfaceDark:          { $value: '#2d0052', $type: 'color' },
      surfaceHoverDark:     { $value: '#3d0070', $type: 'color' },
      borderDark:           { $value: '#ff71ce', $type: 'color' },
      textDark:             { $value: '#fdf4ff', $type: 'color' },
      textMutedDark:        { $value: '#d8b4fe', $type: 'color' },
    },

    arcade: {
      primary:              { $value: '#ff0040', $type: 'color', $description: 'Arcade joystick red primary' },
      primaryHover:         { $value: '#cc0033', $type: 'color' },
      bgLight:              { $value: '#e8eaf6', $type: 'color' },
      surfaceLight:         { $value: '#ffffff', $type: 'color' },
      surfaceHoverLight:    { $value: '#c5cae9', $type: 'color' },
      borderLight:          { $value: '#3f51b5', $type: 'color' },
      textLight:            { $value: '#1a237e', $type: 'color' },
      textMutedLight:       { $value: '#5c6bc0', $type: 'color' },
      blue:                 { $value: '#2196f3', $type: 'color' },
      bgDark:               { $value: '#0d1117', $type: 'color' },
      surfaceDark:          { $value: '#1a1a2e', $type: 'color' },
      surfaceHoverDark:     { $value: '#252545', $type: 'color' },
      borderDark:           { $value: '#2196f3', $type: 'color' },
      textDark:             { $value: '#e8eaf6', $type: 'color' },
      textMutedDark:        { $value: '#7986cb', $type: 'color' },
    },
